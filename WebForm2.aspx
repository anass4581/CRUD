<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="WebApplication7.WebForm2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="margin: 20px;">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <asp:Button ID="Button6" runat="server" Text="Get" OnClick="Button6_Click" CssClass="btn btn-secondary" />
                    ...
                    <%--  <asp:Button ID="ButtonClear" runat="server" Text="Clear All" OnClick="ButtonClear_Click" CssClass="btn btn-secondary" />--%>
                       <%-- <asp:Button ID="Button5" runat="server" Text="Next Page " OnClick="Button5_Click" CssClass="btn btn-primary" />--%>
        ...
        <asp:GridView runat="server" ID="gridview3" CssClass="table table-striped table-bordered"></asp:GridView>
    </div>
</main>
</asp:Content>
